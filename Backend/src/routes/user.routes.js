...
router.route("/forgotPassword").patch(validationSchema(forgotPasswordSchema), forgotPassword);//change to patch

// secured routes
router.route("/logout").post(verifyToken, logoutUser);
router.route("/changeUsername").patch(verifyToken, validationSchema(changeUsernameSchema), changeUsername);//change to patch
router.route("/changePassword").patch(verifyToken, validationSchema(changePasswordSchema), changePassword);//change to patch
router.route("/addDetails").post(verifyToken, validationSchema(addDetailsSchema), addDetails);
router.route("/changeEmail").patch(verifyToken, validationSchema(changeEmailSchema), changeEmail);//change to patch
